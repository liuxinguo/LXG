...
//view/top_bar_fan.php调用
function top_bar_close_real_pare_layer_p()
{
    fojs.dialog.close($('#game_user_online').parent().attr('id'));
}
...
function show_sign_layer()
{
    ...
    if (1 != parseInt(show_flag) && 1==parseInt(window.parent.frames["leftFrame"].qd_need_sign))
    {
