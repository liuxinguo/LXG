            ...
            if(is_wt_shouchong == 1) {
		            ...
		            $('#wtsc_li2_li').show();
	                    ...
	                    //判断是否加载勋章任务flash
	                        ...
	                        swfobject.embedSWF("xz.swf?v=20131209001", "xz_flash", "105", "130", "10.3.0", false, flashvars, params, obj_param);
	                        $('#xz_flash_div').show();
