...
function flashppt(id, w, h, imgUrl, imgLink, imgtext, imgAlt) {
    ...
    str += '<param name="movie" value="/images/home/picppt.swf"><param name="quality" value="high">';
    ...
    str += '<embed src="images/home/picppt.swf" wmode="opaque" FlashVars="bcastr_file=' + files + '&bcastr_link=' + links + '&bcastr_title=' + texts + '& menu="false" quality="high" width="' + swf_width + '" height="' + swf_height + '" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /></object>';
