<?php if (!defined('THINK_PATH')) exit();?><!doctype html><!--[if lt IE 7 ]><html lang="zh" class="ie6"><![endif]--><!--[if IE 7 ]><html lang="zh" class="ie7"><![endif]--><!--[if IE 8 ]><html lang="zh" class="ie8"><![endif]--><!--[if IE 9 ]><html lang="zh" class="ie9"><![endif]--><!--[if (gt IE 9)|!(IE)]><!--><html lang="zh"><!--<![endif]--><head><meta charset="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><meta name="viewport" content="width=1200, initial-scale=1"><meta name="renderer" content="webkit"><meta name="frontend" content="szc"/><title><?php echo ($game["gamename"]); ?>开服列表 - <?php echo ($ai["title"]); ?></title><link rel="stylesheet" type="text/css" href="/images/home/<?php echo ($gamezhuti); ?>/css/global.css"/><link rel="stylesheet" type="text/css" href="/images/home/<?php echo ($gamezhuti); ?>/css/zilong_main_2.css"/><script type="text/javascript" src="/images/home/<?php echo ($gamezhuti); ?>/js/jquery.js"></script><script type="text/javascript" src="http://<?php echo ($ai["domain"]); ?>/js/domain.js"></script><script type="text/javascript" src="http://<?php echo ($ai["domain"]); ?>/game/top?id=<?php echo ($gameid); ?>"></script></head><body><div class="s-body"><div class="s-wrap"><div class="s-header"><a class="s-logo" href="/" target="_blank" title="<?php echo ($game["gamename"]); ?>"><?php echo ($game["gamename"]); ?></a><!-- nav --><div class="s-nav"><a id="s-nav1" class="s-nav1" href="/" target="_blank" title="进入官网">进入官网</a><a id="s-nav2" href="HTTP://bbs.<?php echo ($ai["url"]); ?>" target="_blank" title="游戏论坛">游戏论坛</a><a id="s-nav3" href="HTTP:/pay.<?php echo ($ai["url"]); ?>" target="_blank" title="用户充值">用户充值</a><a id="s-nav4" href="javascript:;" onclick="try{window.external.addFavorite(document.location.href,document.title);}catch(e){try{window.sidebar.addPanel(document.location.href,document.title, '');}catch(e){alert('加入收藏失败，请使用Ctrl+D进行添加,或手动在浏览器里进行设置.');}}" class="bookmark" id="bookmark" title="收藏本页">收藏本页</a></div><!-- login --><div id="loginframe" class="s-loginframe"><ul id="login"  class="log" ><li class="bg-icon s-user"><input placeholder="帐号" type="text" name="username" id="username" class="s-text"></li><li class="bg-icon s-psw"><input type="password" name="userpass" id="userpass" placeholder="密码"  class="s-text"></li><li class="s-log-btn"><a rel="nofollow" id="log-btn" class="block-a" title="登录" href="#" onclick="login();return false;" ></a></li><li class="s-remember"><input class="in02" type="hidden" name="rls"  checked="checked" id="rls" value="sl" /><input type="checkbox" checked="checked" id="remember">&nbsp;
					<label for="remember">记住用户名</label></li><li class="s-psw-btn"><a rel="nofollow" href="http://reg.<?php echo ($ai["url"]); ?>/pwd_find.html" target="_blank" title="忘记密码">忘记密码</a></li><li class="s-reg-btn"><a rel="nofollow" id="btn-reg" href="http://reg.<?php echo ($ai["url"]); ?>/" target="_blank" title="马上注册">马上注册</a></li></ul><div class="loged" id="se_list" style="display:none;"><div class="loged-top">用户信息</div><div class="loged-panel"><ul><li>您好，<a class="loged-highlight" id="uname">888.</a></li><li>您上次进入的服是：</li><li id="last_game_info"></li><li class="loged-usercenter f-ar"><a target="_blank" href="http://user.<?php echo ($ai["url"]); ?>/">用户中心</a><a href="javascript:void(0);" onclick="exit();return false;">注销</a></li></ul></div><div class="loged-bottom"></div></div></div></div><div class="s-content"><p class="s-name">					推荐服务器
				</p><div class="s-server-list rec-server f-cf"><ul class="f-cf" id="history"><?php if(is_array($server1)): $i = 0; $__LIST__ = array_slice($server1,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="http://gameplay.<?php echo ($ai["url"]); ?>/game_add.html?gid=<?php echo ($v['gid']); ?>&sid=<?php echo ($v['sid']); ?>"><?php echo ($v["sid"]); ?>服-<?php echo ($v["servername"]); ?></a></p></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><ul id="server_ban" class="sp-pager f-cf all_server_title clearfix"></ul><div class="" id="all-xz-server"><div id="nameList" class="f-cf" style="display: none;"><a data-name="654" data-type="1" data-nametype="<?php echo ($nametype); ?>">双线</a></div><div class=" all"><div id="sp" class="sp" data-kid="CE5A9B0A-21C8-4427-935B-39417A6F7D59"><div class="sp-panel-wrap all_server_list s-server-list" id="server_all"><ul class="clearfix server_icon" ><?php if(is_array($server1)): $i = 0; $__LIST__ = $server1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="unblok fl"><a href="http://gameplay.<?php echo ($ai["url"]); ?>/game_add.html?gid=<?php echo ($vo['gid']); ?>&sid=<?php echo ($vo['sid']); ?>" t="/server_id=<?php echo ($vo['sid']); ?>" target="_blank"><span></span><?php echo ($vo["sid"]); ?>服-<?php echo ($vo["servername"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div></div></div></div></div></div></div><script type="text/javascript" src="http://tmsh.752g.com/js/home/jquery.pages.js"></script><script type="text/javascript">        $(document).ready(function(){
