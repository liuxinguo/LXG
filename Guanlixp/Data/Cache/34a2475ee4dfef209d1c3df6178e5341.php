...
//-->
  ...
  <form action="<?php echo U('gamepublishadd');?>" method="post" name="Form1" onSubmit="return check()">
  <tr>
    <td width="12%" height="30" align="right" valign="middle"> 新闻标题：</td>
    <td width="88%" valign="middle" class="huise_font"><input name="title" type="text" id="title" size="50"  class="inputclass inputtitle"/> &nbsp;&nbsp;颜色：<input type="text" id="color" value="" name="color" /> <input class="btn m1em_t" type="button" id="colorpicker" value="选择颜色" /></td>
  </tr>
  <tr>
    ...
    <td valign="middle" class="huise_font">
		...
		<?php if(is_array($cate)): $k = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	  </select>
  ...
  <tr>
    <td height="30" align="right" valign="middle">文章作者：</td>
        <td valign="middle" class="huise_font"><input name="author" type="text" class="inputclass" value="游戏小编"> </td>
  </tr>
    <tr>
    <td height="30" align="right" valign="middle">新闻图片：</td>
    <td valign="middle" class="huise_font"><input name="pic" id="pic" type="text" size="50" class="inputclass inputtitle" value=""> <input type="button" class="btn btn-inverse m1em_t" id="image" value="选择图片" /></td>
  </tr>
  <tr id="durl">
    <td height="30" align="right" valign="middle">跳转地址：</td>
    <td valign="middle"><input name="url" type="text" class="inputclass inputtitle" value=""></td>
  </tr>
  <tr>
    <td height="30" align="right" valign="middle">游戏介绍：</td>
    <td valign="middle" class="huise_font"><textarea name="ccontent"  cols="85" rows="3"></textarea></td>
  </tr>
  <tbody id="dcontent">
  <tr>
    <td height="30" align="right" valign="middle">详细内容：</td>
    <td  valign="middle" class="huise_font"><textarea id="content" name="content"  style="width:680px;height:300px;visibility:hidden;"></textarea></td>
  </tr>
  </tbody>
  <tr>
    <td height="30" align="right" valign="middle">浏览次数：</td>
    <td valign="middle" class="huise_font"><input name="clicknum" type="text" size="30" class="inputclass" value="<?php echo rand(100,999);?>"></td>
  </tr>
  <tr>
