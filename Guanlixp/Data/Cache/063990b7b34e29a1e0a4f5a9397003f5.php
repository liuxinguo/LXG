...
<body>
        ...
        <div class="hero-unit home_prompt">
          <h1>欢迎使用 Eyou ！</h1>
          <p>这是您第一次与Eyou接触，Eyou设计初衷就是为了让设计师、程序员、以及不懂网站的初学者能够轻松建立使用网站。</p>
          <p>Eyou还有许多您不知道的小秘密，希望我们在以后的日子里相处愉快。</p>
          <p>&nbsp;</p>
          <p> <a href="http://www.eyouwan.com" target="new" class="btn btn-primary btn-large"> 前往学习中心 </a> </p>
        </div>
