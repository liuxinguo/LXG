...
//-->
  ...
  <tr>
    ...
    <td valign="middle" class="huise_font">
        ...
        <?php if(is_array($game)): $i = 0; $__LIST__ = $game;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$game): $mod = ($i % 2 );++$i;?><option value='<?php echo ($game["id"]); ?>' <?php if($game["id"] == $vo['gid']): ?>selected='selected'<?php endif; ?>><?php echo ($game["gamename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        &nbsp;&nbsp;链接类型：
  ...
  <tr>
    ...
    <td valign="middle" class="huise_font"><input name="webname" id="webname" type="text" size="50" class="inputclass inputtitle" value="<?php echo ($vo["webname"]); ?>" /></td>
  </tr>  
  
  <tr>
    <td height="30" align="right" valign="middle">链接地址：</td>
    <td valign="middle" class="huise_font"><input name="website" id="website" type="text" size="50" class="inputclass inputtitle" value="<?php echo ($vo["website"]); ?>" /></td>
  </tr>
  
  <tr>
    <td height="30" align="right" valign="middle">LOGO图片：</td>
    <td valign="middle" class="huise_font"><input name="pic" id="pic" type="text" size="50" class="inputclass inputtitle" value="<?php echo ($vo["pic"]); ?>" /> &nbsp;<input type="button" id="image" class="btn btn-inverse m1em_t" value="选择图片" /> </td>
  </tr>

  <tr>
    <td height="30" align="right" valign="middle">联系QQ：</td>
    <td valign="middle" class="huise_font"><input name="qq" id="qq" type="text" size="50" class="inputclass inputtitle" value="<?php echo ($vo["qq"]); ?>" /></td>
  </tr>
  
  <tr>
    <td height="30" align="right" valign="middle">联系邮箱：</td>
    <td valign="middle" class="huise_font"><input name="email" id="email" type="text" size="50" class="inputclass inputtitle" value="<?php echo ($vo["email"]); ?>" /></td>
  </tr>
  
  <tr>
    <td height="30" align="right" valign="middle">联系电话：</td>
    <td valign="middle" class="huise_font"><input name="tel" id="email" type="text" size="50" class="inputclass inputtitle" value="<?php echo ($vo["tel"]); ?>" /></td>
  </tr> 
  ...
  <tr>
    ...
    <td valign="middle" class="huise_font">
        显示 <input type="checkbox" name="isdisplay" value="1" <?php if($vo["isdisplay"] == 1): ?>checked<?php endif; ?>> 
        审核 <input type="checkbox" name="status" value="1" <?php if($vo["status"] == 1): ?>checked<?php endif; ?>></td>
  </tr>
  <tr>
