...
<!--<table class="pagination-i">
  ...
  <form action="<?php echo U('game_del');?>" method="post" name="form1">
<table class="table table-bordered table-striped">
<thead>
  <tr >
    <th nowrap class="table-textcenter">选择</th>
    <th class="table-textcenter"><a href="<?php echo U('game',array('sort'=>$get['sort']));?>">排序显示</a></th>
    <th class="table-textcenter">标签</th>
    <th class="table-textcenter">gid</th>
    <th class="table-textcenter">游戏名称</th>
    <th class="table-textcenter">游戏类型</th>
    <th class="table-textcenter">游戏类别</th>
    <th class="table-textcenter">游戏状态</th>
    <th class="table-textcenter">ICON图片</th>
    <th class="table-textcenter">游戏单位</th>
    <th class="table-textcenter">游戏比率</th>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.className='mouseon'" onMouseOut="this.className='';">    
    ...
    <td class="table-textcenter"><?php echo ($vo["gametype"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["category"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["statetype"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["pic"]["icon"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["unit"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["rate"]); ?></td>
    ...
    <td class="table-textcenter"><a href="<?php echo U('game_edit',array('id'=>$vo['id']));?>">修改</a></td>
