...
function gotoserver(){
  ...
  <table class="table set_table">
    <form action="<?php echo U('fuli/fl_log',array('begintime'=>$Think['begintime'],'endtime'=>$Think['endtime']));?>" name="Form2" method="post">
    <tr>
...
<thead>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.className='mouseon'" onMouseOut="this.className='';">    
    ...
    <td class="table-textcenter"><?php echo ($vo["sntime"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["uname"]); ?></td>
    <td class="table-textcenter"><?php echo ($vo["vip"]); ?></td>
    <th class="table-textcenter"><?php echo ($vo["money"]); ?></th>
    <td class="table-textcenter"><?php echo ($vo["df"]); ?>%</td>
    <td class="table-textcenter"><?php echo ($vo["vf"]); ?>%</td>
    <td class="table-textcenter"><?php echo ($vo["bili"]); ?>%</td>
    <td class="table-textcenter"><?php echo ($vo["fanli"]); ?></td>  
    <td class="table-textcenter">平台币</td>
    <td class="table-textcenter"><?php echo ($vo["payip"]); ?></td>
    <td class="table-textcenter"><?php echo (date('Y-m-d H:i:s',$vo["successtime"])); ?></td>
