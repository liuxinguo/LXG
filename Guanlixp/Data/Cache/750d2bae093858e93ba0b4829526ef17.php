...
function gotoserver(){
  ...
  <table class="table set_table">
    ...
    <form action="<?php echo U('login_log',array('begintime'=>$Think['begintime'],'endtime'=>$Think['endtime']));?>" name="Form2" method="post">
    <tr>
...
<table class="table table-bordered table-striped">
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.className='mouseon'" onMouseOut="this.className='';" class="tabletr">
    ...
    <td class="table-textcenter"><?php echo ($vo["loginip"]); ?></td>
    ...
    <td class="table-textcenter"><?php echo (date('Y-m-d H:i:s',$vo["logintime"])); ?></td>
