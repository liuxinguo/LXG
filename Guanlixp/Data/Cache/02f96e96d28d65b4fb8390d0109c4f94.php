...
function gotoserver(){
    ...
    <form action="<?php echo U('card_log',array('begintime'=>$Think['begintime'],'endtime'=>$Think['endtime']));?>" name="Form2" method="get" >
 <table class="table set_table">
    <tr>
            <td height="30" width="200" class="table-textcenter">查询时间：</td>
    ...
    <tr>
            ...
            <input type="submit" name="submit" value='查 询' class="btn btn-primary btn-small" /> <input type="reset" name="reset" value='重 置' class="btn btn-primary btn-small" />
                ...
                <span style="float:right;padding-right:10px;line-height:30px;">总兑换数量：<?php echo ($sumcount); ?> 张&nbsp;&nbsp;</span>
            </td>
</tr>
</TABLE>
    </form>
...
<thead>
  <tr>
    <th width="9%" class="table-textcenter">编号</th>
    <th width="11%" class="table-textcenter">新手卡</th>
    <th width="11%" class="table-textcenter">新手卡标识</th>
    <th width="16%" class="table-textcenter">游戏名称</th>
    <th width="27%" class="table-textcenter">服务器名称</th>
    <th width="15%" class="table-textcenter">平台帐号</th>
    <th width="11%" class="table-textcenter">激活时间</th>
  </tr>
</thead>
